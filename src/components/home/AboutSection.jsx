...
const AboutSection = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className='min-h-screen section-dark-alt text-white relative depth-3 section-transition holographic'>
      ...
      <div className='container mx-auto section-padding'>
        ...
        <div className='about-grid max-width-wide'>
          <ScrollReveal direction="scale" className='floating-panel-dark mb-12 sm:mb-16 glass-enhanced border-glow'>
            <div className='responsive-grid-2 items-center'>
            {/* Story Content */}
              <ScrollReveal direction="left" className='about-content space-y-6 sm:space-y-8 order-2 lg:order-1'>
                <div>
              ...
              {/* Image Placeholder */}
              <ScrollReveal direction="right" className='about-content order-1 lg:order-2'>
          ...
          {/* Values Grid */}
          <ScrollReveal direction="up" stagger={0.2} className='responsive-grid-3'>
            <div className='about-content text-center space-y-4'>
              <HoverLift liftAmount={12} scale={1.05} glowEffect={true}>
                <AmbientLight className='floating-panel-dark glass-hover space-y-4 sm:space-y-6 glass-enhanced border-glow spotlight tilt-effect'>
                  <div className='text-3xl sm:text-4xl lg:text-5xl mb-3 sm:mb-4 micro-bounce glow-accent float-animation pulse-glow'>🎯</div>
